...
$mail->Subject = "Urban Activation | Brochure Contact Form";
...
$mailUser->Subject = "Urban Activation | Brochure Enquiry Form";
...
$_SESSION['sent']=1;
$_SESSION['pdf']=trim($_POST['pdf']);
	
if($_SERVER['HTTP_REFERER'])
	//echo "<br />Returning to the HTTP Referer";
	header('Location: '.$_SERVER['HTTP_REFERER']);	
exit;
