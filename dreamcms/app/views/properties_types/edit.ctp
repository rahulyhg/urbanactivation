...
$(function(){
	$('#PropertiesTypeType').friendurl({id : 'PropertiesTypeSeoPageName', transliterate: true});
});
</script>
	...
	<div id="record">
        <div id="record_header_wrap">
        	<div id="record_header">
        		<div id="record_detail">Edit Item: <?php echo $this->data['PropertiesType']['id']; ?></div>
        	</div>
    	</div>
		<?php 
		echo $this->Form->create('PropertiesType', array('class'=>'editForm'));
