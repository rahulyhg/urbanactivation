...
<h2><?php  __('Image');?></h2>
	<dl><?php $i = 0; $class = ' class="altrow"';?>
		...
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php  echo $this->Html->image('thumbnails/' . $image['Image']['location'], array('alt' => $image['Image']['name'])); ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Categorie'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $this->Html->link($image['Categorie']['name'], array('controller' => 'categories', 'action' => 'view', $image['Categorie']['id'])); ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Made'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $image['Image']['made']; ?>
			&nbsp;
		</dd>
    ...
    Download link for large image.<br />
    <?php  echo $this->Html->image('medium/' . $image['Image']['location'], array('alt' => $image['Image']['name'])); ?>
</div>
<div class="actions">
