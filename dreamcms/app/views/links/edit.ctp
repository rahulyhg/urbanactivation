...
<div id="record">
        ...
        if(strlen($this->data['Link']['logo'])<=0){
			...
			<div class="input">
            	...
            	<img src="<?php echo Configure::read('Company.url');?>dreamcms/app/webroot/uploads/links/<?php echo $this->data['Link']['logo'];?>" height="100"/>
                <!--<a href="<?php echo Configure::read('Company.url');?>dreamcms/index.php/links/deletefile/<?php //echo $this->data['Link']['id'];?>/<?php //echo $this->data['Link']['logo'];?>" >Delete File</a>-->
