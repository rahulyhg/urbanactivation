...
$(function(){
	$('#PropertiesCategoryCategory').friendurl({id : 'PropertiesCategorySeoPageName', transliterate: true});
});
</script>
<div class="propertiesCategories form">
	<div id="record">
        <div id="record_header_wrap">
        	<div id="record_header">
        		<div id="record_detail">Edit Item: <?php echo $this->data['PropertiesCategory']['id']; ?></div>
        	</div>
    	</div>
		<?php 
		echo $this->Form->create('PropertiesCategory', array('class'=>'editForm'));
