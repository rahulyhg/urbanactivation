...
<div id="record">
        <div id="record_header_wrap">
        	<div id="record_header">
        		<div id="record_detail">Edit Item: <?php echo $this->data['Setting']['id']; ?></div>
        	</div>
    	</div>
		<?php 
			echo $this->Form->create('Setting', array('class'=>'editForm', 'enctype'=>'multipart/form-data', 'type'=> 'file'));
