...
<div class="projectsCategories form">
	<div id="record">
        <div id="record_header_wrap">
        	<div id="record_header">
        		<div id="record_detail">Edit Item: <?php echo $this->data['ProjectsCategory']['id']; ?></div>
        	</div>
    	</div>
	<?php 
		echo $this->Form->create('ProjectsCategory', array('class'=>'editForm'));
